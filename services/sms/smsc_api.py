...
SMSC_LOGIN = "servbit"			# логин клиента
SMSC_PASSWORD = "5ade8022492df1bba9242d4caf0b80946956ed13"		# пароль
...
class SMSC(object):
	...
	# 							6 - ping-sms, 7 - mms, 8 - mail, 9 - call, 10 - viber, 11 - soc)
	...
	def get_error_message(self, error_number=0):
		""" Возвращаем текстовое описание ошибки по номеру error из API """
		errors = {
			0: "Нет описания ошибки",
			...
			9: "Отправка более одного одинакового запроса за короткое время",
		}

		return errors.get(error_number)
